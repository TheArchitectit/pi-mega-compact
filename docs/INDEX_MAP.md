...
| **S26 spec (importance scoring for compaction — typed multipliers, age decay, recency/retention boost, feature-flagged preservation of decisions/errors)** | [specs/s26-importance-scoring.md](specs/s26-importance-scoring.md) | docs/specs/ |
| **S27 spec (self-RAG quality gate — word-overlap critique for recall injection, factual accuracy, completeness, relevance, clarity metrics)** | [specs/s27-self-rag-quality-gate.md](specs/s27-self-rag-quality-gate.md) | docs/specs/ |
| **S28 RAG spec (RAPTOR multi-level retrieval + incremental enrichment — level-weighted scoring, leaf expansion, build history, enrichment scheduler)** | [specs/s28-raptor-multilevel-retrieval.md](specs/s28-raptor-multilevel-retrieval.md) | docs/specs/ |
| **S29 RAG spec (HyDE for vague recall queries — hypothetical document embedding, multi-query expansion, RRF fusion, vagueness detection)** | [specs/s29-hyde-vague-queries.md](specs/s29-hyde-vague-queries.md) | docs/specs/ |
| **S30 spec (three-tier latency-aware recall routing — L0 in-memory cache, L1 FTS5 trigram, L2 PGlite HNSW; embedding cache, session invalidation, hit-rate tracking)** | [specs/s30-three-tier-latency-routing.md](specs/s30-three-tier-latency-routing.md) | docs/specs/ |
| **S31 spec (CRAG quality metrics — relevance, coverage, diversity, specificity; query expansion on low quality, quality telemetry)** | [specs/s31-crag-quality-metrics.md](specs/s31-crag-quality-metrics.md) | docs/specs/ |
| **S32 spec (visual memory map dashboard — reactflow graph of memories, temporal/causal/topical edges, filter controls, detail panel)** | [specs/s32-visual-memory-map.md](specs/s32-visual-memory-map.md) | docs/specs/ |
| **S33 spec (auto-categorizing memory wiki — rule-based + LLM topic assignment, wiki page generation, topic tree browser)** | [specs/s33-auto-categorizing-wiki.md](specs/s33-auto-categorizing-wiki.md) | docs/specs/ |
