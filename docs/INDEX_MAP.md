...
| **Local RAG MCP program (LRMCP-0–LRMCP-8 — explicit-start, read-only stdio server; curated checkpoint/memory/turn/topic/wiki/RAPTOR/quality access; immutable grants, opaque aliases, redaction, npm bin)** | [specs/local-rag-mcp-program.md](specs/local-rag-mcp-program.md) | docs/specs/ |
