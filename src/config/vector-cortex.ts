...
// VC9A/VC9B extracted to vector-cortex-vc9{a,b}.ts to keep this file under the
// 300-line soft limit; re-exported so existing imports keep resolving unchanged.
