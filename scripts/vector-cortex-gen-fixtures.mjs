...
const manifest = {
  ...
  domain: "evaluation,replay,events",
  owner: "VC0A,VC0B,VC1A",
  schemaVersion: "metric-event-v1;replay-cut-v2;event-v2",
  license: "synthetic",
...
console.log(
  `generated ${fixtures.length} evaluation + ${replayFixtures.length} replay + ${eventFixtures.length} event fixtures + ${Object.keys(schemas).length} schemas + manifest under ${relativePath()}`,
);
