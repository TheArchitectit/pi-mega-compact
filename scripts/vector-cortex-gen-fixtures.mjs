 ...
 * (schemas, evaluation, replay, events, resilience) + the canonical writer.
 *
...
const { evalCount, replayCount, eventCount, resilienceCount, namedCount, schemaCount } = writeAll();

console.log(
  `generated ${evalCount} evaluation + ${replayCount} replay + ${eventCount} event fixtures + ${resilienceCount} resilience + ${namedCount} named resilience fixtures + ${schemaCount} schemas + manifest under conformance/vector-cortex/v2`,
);
